...
esc = prompt("A semana demorou a passar, você estudou muito e trabalhou mais ainda.Você sente um misto de 'preciso me divertir um pouco' com 'quero dormir até o fim da vida' e no meio desse raciocínio você recebe uma mensagem do Alex (seu amigo de infância) te convidadno para uma festa. Você aceita o convite?\n\n-SIM\n\n-NÃO").toUpperCase()
...
if(esc == "ENCONDER-SE ATRÁS DE UMA CAIXA") {

  esc = prompt("Alex ainda está desacordado e os homens conseguem derrubar a porta, mas nenhum deles entra, você fica confuso, pois o barulho para assim que a porta é derrubada, segundos depois uma granada de fumaça amarela rola sala a dentro, você decide:\n\n-SAIR PELA PORTA\n\n-CONTINUAR ESCONDIDO\n\n-").toUpperCase()
                                //CAMINHO PENDENTE   -   CAMINHO PENDENTE - FAZER ALTERNATIVA      

}

if(esc == "INVESTIGAR O LOCAL") {
    
    esc = prompt("Ao investigar bem o lugar você encontra três objetos que chamam sua atenção:\n\n-Uma Faca\n-Uma pistola\n-Um celular, você deve ser muito bom em procurar coisas, pois todos eles estavam bem escondidos entre as caixas, prateleiras e entulho da sala, você decide pegar qual deles?\n\n-FACA\n\n-PISTOLA\n\n-CELULAR").toUpperCase()
